...
<div class="col-lg-12">
    <div class="form-group">
        <label for="image" class="required-field">Image</label>
        <input type="file" class="form-control" id="image" name="image">
        @if($item->getFirstMediaUrl('catering_menu_category_images'))
            <img src="{{ $item->getFirstMediaUrl('catering_menu_category_images') }}" alt="Food Image" width="30%">
        @endif
    </div>
</div>