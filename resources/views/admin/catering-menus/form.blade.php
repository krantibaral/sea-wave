...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <input class="form-control" id="menuName" placeholder="Menu Name" name="menu_name"
                value="{{ old('menu_name', $item->menu_name) }}">
        </div>
    </div>
    ...
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <select class="form-control" id="menuCategory" name="catering_menu_category_id">
                @foreach($menuCategories as $category)
                    <option value="{{ $category->id }}" {{ old('catering_menu_category_id', $item->catering_menu_category_id ?? '') == $category->id ? 'selected' : '' }}>
