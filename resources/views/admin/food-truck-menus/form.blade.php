...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <select class="form-control" id="menuCategory" name="food_truck_category_id">
                @foreach($menuCategories as $category)
                    <option value="{{ $category->id }}" {{ old('food_truck_category_id', $item->food_truck_category_id ?? '') == $category->id ? 'selected' : '' }}>
